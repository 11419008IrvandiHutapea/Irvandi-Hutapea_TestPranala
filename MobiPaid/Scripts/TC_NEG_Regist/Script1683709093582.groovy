...
WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_signatory_first_name'), 'Pransena')

WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_signatory_last_name'), 'Hut')

WebUI.setText(findTestObject('Object Repository/Page_Register/input_Login_email'), 'hut@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Register/input_Login_password'), '91Aed6jeBGSQu+00Y+kCQQ==')
